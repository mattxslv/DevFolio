...
- PEMEDES Licensing Portal (https://register.pemedes.gov.ph/): official DICT licensing portal regulating the Private Express and Messengerial Delivery Service sector, the country's motorcycle-based courier and delivery industry. Operators and riders register fully online with National ID verification via the PSA e-Verify system, AI-assisted document validation, agent review and approval workflows, payment verification, and issuance of QR-coded digital licenses (Messenger Work License virtual IDs) and operator certificates. Built with Next.js 15, React 19, TypeScript, and Cloud SQL (PostgreSQL), deployed on Google Cloud Run.
